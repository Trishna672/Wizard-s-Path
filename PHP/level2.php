...
// Level configuration (Level 2)
$level = [
    'id' => 2,
    'bg' => "assets/level2_bg.png",
    'obstacles' => [
        ['x' => 180, 'y' => 300, 'w' => 60, 'h' => 30, 'dx' => 0, 'img' => 'assets/obstacles2.png'],
        ['x' => 320, 'y' => 260, 'w' => 60, 'h' => 30, 'dx' => 1, 'img' => 'assets/obstacles2.png'],
        ['x' => 480, 'y' => 230, 'w' => 60, 'h' => 30, 'vanish' => 1, 'img' => 'assets/obstacles2.png'],
        ['x' => 620, 'y' => 270, 'w' => 60, 'h' => 30, 'bounce' => 1, 'img' => 'assets/obstacles2.png']
    ],
    'hazards' => [
        ['x' => 300, 'y' => 320, 'w' => 50, 'h' => 30, 'img' => 'assets/spikes.png'],
        ['x' => 450, 'y' => 320, 'w' => 50, 'h' => 30, 'img' => 'assets/spikes.png']
    ],
    'goal' => ['x' => 500, 'y' => 50, 'w' => 50, 'h' => 100, 'img' => 'assets/portal.png'],
    'next_battle' => 'battle2.php',
    'orb' => [
        ['x' => 250, 'y' => 200, 'w' => 20, 'h' => 20, 'collected' => $_SESSION['orb'][0]],
        ['x' => 400, 'y' => 180, 'w' => 20, 'h' => 20, 'collected' => $_SESSION['orb'][1]],
        ['x' => 520, 'y' => 150, 'w' => 20, 'h' => 20, 'collected' => $_SESSION['orb'][2]],
        ['x' => 700, 'y' => 170, 'w' => 20, 'h' => 20, 'collected' => $_SESSION['orb'][3]]
    ]
];
...
<head>
    <title>Level 2 — A Wizard's Path</title>
    <style>
        html,
        body {
            margin: 0;
...
<body>
    <canvas id="gameCanvas" aria-label="Level 2 game canvas" tabindex="0"></canvas>
    ...
    <script>
        ...
        function update() {
            ...
            // Obstacles (with vanish/bounce support)
            for (let obs of obstacles) {
                ...
                if (player.x < obs.x + obs.w && player.x + player.width > obs.x && player.y < obs.y + obs.h && player.y + player.height > obs.y && obs.visible) {
                    if (player.dy > 0 && player.y + player.height - player.dy <= obs.y) {
                        ...
                        if (obs.bounce) player.dy = -12; // trampoline bounce
                    } else {
